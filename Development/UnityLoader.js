...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'DemoBuild1.data';
    var REMOTE_PACKAGE_BASE = 'DemoBuild1.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 17983012;
      var PACKAGE_UUID = 'b28c902f-1f37-4888-b7ff-17f98f83c510';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 14309757, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(14309757, 14312376, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(14312376, 14318087, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(14318087, 16459327, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(16459327, 17955387, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(17955387, 17983012, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_DemoBuild1.data');

    };
    Module['addRunDependency']('datafile_DemoBuild1.data');
